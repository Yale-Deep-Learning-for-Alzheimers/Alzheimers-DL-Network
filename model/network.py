...
class Network(nn.Module):
    ...
    def __init__(self, input_channels, input_shape, output_size, lstm_layers=1):
        ...
        self.convolution1 = nn.Conv3d(input_channels, 50,kernel_size,padding=padding) #TODO: Optimize ALL of these when Data Size is known
        ...
        self.convolution2 = nn.Conv3d(50, 10,kernel_size,padding=padding)
